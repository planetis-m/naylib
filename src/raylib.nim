...
func genImageText*(width: int32, height: int32, text: cstring): Image {.importc: "GenImageText".}
...
func waveCrop*(wave: var Wave, initSample: int32, finalSample: int32) {.importc: "WaveCrop".}
...
proc resumeAudioStream*(stream: AudioStream) {.importc: "ResumeAudioStream".}
  ## Resume audio stream
func isAudioStreamPlaying*(stream: AudioStream): bool {.importc: "IsAudioStreamPlaying".}
