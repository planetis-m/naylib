...
type
  VertexBuffer* {.importc: "rlVertexBuffer", header: "rlgl.h", nodecl, bycopy.} = object ## Dynamic vertex buffers (position + texcoords + colors + indices arrays)
  ...
  DrawCall* {.importc: "rlDrawCall", header: "rlgl.h", nodecl, bycopy.} = object ## of those state-change happens (this is done in core module)
  ...
  RenderBatch* {.importc: "rlRenderBatch", header: "rlgl.h", nodecl, bycopy.} = object ## rlRenderBatch type
